...
- charts-multi-module-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- charts-multi-module-ui: main application module, development time
- charts-multi-module-production: module that produces a production mode WAR for deployment
